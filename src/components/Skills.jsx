...
function Skills() {
  return (
    <div id="Skills" className="w-full mt-25 mb-35 scroll-mt-30">
      <h2 className="mx-auto w-[50%] text-primary text-center mb-25 text-3xl xl:text-4xl 2xl:text-5xl underline underline-offset-12">
        Skills
      </h2>
      <div className="flex justify-around mx-48">
        {/* front-end section */}
        <div className="w-[45%] flex flex-col bg-base-300 rounded-3xl p-10 pb-0">
          <div className="flex gap-5 items-center justify-center mb-20">
            <img src="icons/frontend.png" className="w-18" alt="" />
          ...
          <div className="flex justify-evenly flex-wrap">
            ...
            <Skill icon="icons/html.png" skillDesc="HTML" marginB={0} />
          </div>
        </div>
        {/* back-end section */}
        <div className="w-[45%] flex flex-col bg-base-300 rounded-3xl p-10 pb-0 ">
          <div className="flex gap-5 items-center justify-center mb-20">
            <img src="icons/backend.png" className="w-18" alt="" />
          ...
          <div className="flex justify-evenly flex-wrap">
            ...
            <Skill icon="icons/database.png" skillDesc="SQL/MongoDB" marginB={0} />
          </div>
        </div>
      </div>
    </div>
